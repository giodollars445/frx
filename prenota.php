...
if (!$isWorkingDay) {
    ...
    <head>
        ...
        <title>Errore - Bella Vista Hair Salon</title>
...
<head>
    ...
    <title><?php echo $success ? 'Prenotazione Confermata' : 'Errore Prenotazione'; ?> - Bella Vista Hair Salon</title>
        ...
        * {
        ...
        .message-container {
            ...
            box-shadow: 
                ...
                0 25px 50px rgba(<?php echo $success ? '34, 197, 94' : '239, 68, 68'; ?>, 0.1),
        ...
        <?php if ($success): ?>
            ...
            <div class="booking-details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-label">Parrucchiera:</span>
